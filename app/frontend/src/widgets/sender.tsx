...
import { faVolumeHigh, faDisplay, faNetworkWired } from "@fortawesome/free-solid-svg-icons";
...
import { Source, Status, TransportStrategy } from "../bridge";
        ...
        <>
            <div className='item'>
                ...
                >
                    ...
                    {settings.network.server && <option value='Relay'>{locales.Relay}</option>}
                </select>
            </div>
        </>
    );
